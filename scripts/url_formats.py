...
# order_json_fmt = r'https://steamcommunity.com/market/itemordersactivity?country=JP&currency=1&language=english&item_nameid={market_id:d}&two_factor=0'
order_json_fmt = r'https://steamcommunity.com/market/itemordershistogram?country=JP&currency=1&language=english&item_nameid={market_id:d}&two_factor=0'
